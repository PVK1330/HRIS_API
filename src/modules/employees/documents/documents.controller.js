...
const listCatalog = asyncHandler(async (req, res) => {
  const data = await service.listCatalogTypes(req.user, req.params.employeeId);
...
const create = asyncHandler(async (req, res) => {
  const data = await service.createDocument(req.user, req.params.employeeId, req.body, req.file);
