...
const performanceRoutes = require("./performance/performance.routes");
const assetsRoutes = require("./assets/assets.routes");
>>>>>>> 0d8c05e842fcd52257d7685ec21dd765054d2c5e

const router = Router();
router.use(
  authenticate,
  requireRole("superadmin", "admin", "hr_admin", "hr_executive", "manager"),
);
...
router.post(
  ...
  [
    ...
    body("joinDate")
      .exists({ checkFalsy: true })
      .withMessage("joinDate is required")
      .isDate(),
    body("workEmail")
      .exists({ checkFalsy: true })
      .withMessage("workEmail is required")
      .isEmail()
      .normalizeEmail(),
    ...
    body("employmentStatus")
      .optional()
      .isIn(["Active", "Probation", "Notice Period", "On Leave", "Terminated"]),
